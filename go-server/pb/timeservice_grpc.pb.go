...
type TimeServiceClient interface {
	Now(ctx context.Context, in *NewRequest, opts ...grpc.CallOption) (*TimeUpdate, error)
...
func (c *timeServiceClient) Now(ctx context.Context, in *NewRequest, opts ...grpc.CallOption) (*TimeUpdate, error) {
	out := new(TimeUpdate)
...
type TimeServiceServer interface {
	Now(context.Context, *NewRequest) (*TimeUpdate, error)
...
func (UnimplementedTimeServiceServer) Now(context.Context, *NewRequest) (*TimeUpdate, error) {
...
func _TimeService_Now_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServiceServer).Now(ctx, req.(*NewRequest))
	}
